...
class Learner:
    ...
    def parse_command_line(self):
        ...
        if args.dataset == "ssv2-cmn":
            args.traintestlist = os.path.join(args.data_folder, "video_dataset/splits/ssv2_CMN")
            args.path = os.path.join(args.data_folder, "video_dataset/SSV2-CMN/video_frame")
        elif args.dataset == "ssv2-otam":
            args.traintestlist = os.path.join(args.data_folder, "video_dataset/splits/ssv2_OTAM")
            args.path = os.path.join(args.data_folder, "video_dataset/SSV2-OTAM/video_frame")
        elif args.dataset == "kinetics":
            args.traintestlist = os.path.join(args.data_folder, "video_dataset/splits/kineticsTrainTestlist")
            args.path = os.path.join(args.data_folder, "video_dataset/Kinetics-100/video_frame")
        elif args.dataset == "ucf":
            args.traintestlist = os.path.join(args.data_folder, "video_dataset/splits/ucf_ARN")
            args.path =os.path.join(args.data_folder, "video_dataset/UCF/video_frame")
        elif args.dataset == "hmdb":
            args.traintestlist = os.path.join(args.data_folder, "video_dataset/splits/hmdb_ARN")
            args.path = os.path.join(args.data_folder, "video_dataset/HMDB51/video_frame")
